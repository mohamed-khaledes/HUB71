...
export default function NotFound() {
  return (
    <html>
      <body>
        <div className='flex flex-col items-center justify-center min-h-screen bg-linear-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 text-center px-6'>
